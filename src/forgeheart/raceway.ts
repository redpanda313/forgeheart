...
function zoneColor(t: number): {
  ...
  if (t < 0.18) return { road: 0x5a5348, side: 0xa8925a, accent: 0xb87333, foliage: 0x3a4a38, name: 'brass' };
  if (t < 0.38) return { road: 0x5a5348, side: 0x5a5848, accent: 0xe8b84a, foliage: 0x3a4a38, name: 'park' };
  if (t < 0.55) return { road: 0x4a3a55, side: 0xd45d9a, accent: 0x5ec8e8, foliage: 0x5a3d6a, name: 'market' };
  if (t < 0.75) return { road: 0x3a4a5a, side: 0x4a9ec8, accent: 0xf0d080, foliage: 0x3a5a52, name: 'canal' };
  return { road: 0x5a4030, side: 0xe07040, accent: 0xffd070, foliage: 0x4a5a38, name: 'sunset' };
}
